...
import de.dhbw.humbuch.ui.screens.DunningScreen;
...
public class NavigationUI extends ScopedUI {
	...
	@Inject
	private DunningScreen dunningScreen;
	...
	protected void init(VaadinRequest request) {
         ...
         */
      	...
      	navigator.addView(DUNNING, dunningScreen);
	}
